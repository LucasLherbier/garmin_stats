...
# from actions import race_coach  # Prep coach (Gemini) — disabled until billing/API ready
from utils.pipeline.preprocess_activities import TRAINING_RACE_PERIODS

# Prep coach LLM (workout_summaries → Gemini narrative). Re-enable when GEMINI billing is set up.
